...
需要满足所有要求一般使用投屏，我看到许多人都推荐scrcpy，自己使用之后也觉得非常好用，开源、轻量、简单。scrcpy不仅能投屏还能在电脑上控制手机，声音也可以投屏，显示很清晰，速度快，可以通过USB连接，也可以通过Wifi连接，并且不需要手机root权限，同时适用于Linux、Windows和MacOS。在有公司网络或者校园网的场景中非常舒适，延迟低，还能远程控制设备。
